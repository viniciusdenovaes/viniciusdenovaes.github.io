...
Considere que você fará um banco de dados de uma pizzaria. O banco de dados terá apenas as entidades `Cliente` e `Pizza` e uma relação entre elas que é o `Pedido`, cada `Pedido` relaciona uma pizza com um cliente.
