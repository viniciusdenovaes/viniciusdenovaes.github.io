...
\question Descreva formalmente um espaço de estados para o problema do fazendeiro.
...
\question Considere o Problema do Caixeiro Viajante (TSP): Um vendedor sai de sua casa planejando passar em um conjunto de casas escritas em uma lista. Qual percurso este vendedor deve fazer para andar o menor tempo possível?
...
\item Considere a estratégia do vendedor sempre pegar o caminho para a casa que falta mais próxima de onde ele está parado. Dê um exemplo para o problema do caixeiro viajante para no qual esta estratégia gulosa não consiga encontrar uma solução ótima. 
...
\question Descreva o espaço de estado dos seguintes problemas:
\begin{enumerate}[a)]
...
\question Considere um espaço de estados onde o estado inicial tem valor 1 e o arco sucessor para o estado $n$ aponta para dois filhos com os número $2n$ e $2n+1$.
\begin{enumerate}[a)]
