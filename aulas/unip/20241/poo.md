...
* Parte 00 - Revisão: Levamos em consideração que a turma aprendeu o paradigma de programação estruturada programando em Python. Será feito uma revisão de tipos primitivos, comandos de controle e procedimentos focando na sintaxe em Java.
